      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <form onSubmit={submit} className="rounded-[8px] border border-white/10 bg-white p-5 text-ink shadow-soft md:p-6">
          <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-sm font-semibold text-pine">Phase 12 onboarding</p>
              <h3 className="text-2xl font-semibold">Book demo or start setup</h3>
            </div>
          ...
          {submitted ? (
            <div className="rounded-[8px] bg-mist p-5">
              ...
              <p className="mt-2 leading-7 text-steel">
                This is ready to connect to backend lead storage. For now, the owner can jump into
                the console and see the operating flow immediately.
              </p>
              <Link
                href="/app"
            ...
            <>
              ...
              <div className="mt-6 flex flex-wrap justify-between gap-3">
                ...
                <button className="flex h-11 items-center gap-2 rounded-[8px] bg-pine px-4 font-semibold text-white">
